<h1 align="center"> 
	Web page cryptocurrency 
</h1>

<p align="center">
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/JacksonSantin/crypto-page?color=%238257E5">

  <img alt="GitHub top language" src="https://img.shields.io/github/languages/top/JacksonSantin/crypto-page?color=%238257E5">
...
**Web page Cryptocurrency** - Aplicação desenvolvida para praticar o básico da programação, html, css, javascript, ajax, consumindo API para atualização dos valores das moedas.
...
Este projeto esta sobe a licença [MIT](https://github.com/JacksonSantin/crypto-page/blob/master/LICENSE).
